...
use Otus\Models\Lists\ProceduresPropertyValuesTable;
...
class HospitalClientsTable extends DataManager
{
    ...
    public static function getMap()
    {
        return [
            ...
            (new Reference('HEALERS', HealersPropertyValuesTable::class,
                Join::on('this.doctor_id', 'ref.IBLOCK_ELEMENT_ID')))
                ->configureJoinType('inner'),
            (new Reference('PROCEDURES', ProceduresPropertyValuesTable::class,
